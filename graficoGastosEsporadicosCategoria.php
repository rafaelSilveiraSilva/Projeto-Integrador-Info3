...
// FAZ UMA QUERY NO BD PARA SOMAR OS GASTOS ESPORÁDICOS MENSAIS
...
WHERE te.usuario_id = $usuario_id AND te.tipo = 'Gasto' AND te.ativo = 1 AND  MONTH(te.dataDaTransacao) = MONTH(CURRENT_DATE()) AND YEAR(te.dataDaTransacao) = YEAR(CURRENT_DATE()) 
GROUP BY c.nome
");
...
$graph->title->Set('Gastos esporadicos por categoria');
