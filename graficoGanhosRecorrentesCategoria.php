...
$rsPlot = $mysql->query("SELECT SUM(tr.valor) AS totalCat, c.nome AS nomeCategoria
FROM transacaorecorrente tr JOIN categoria c ON tr.categoria_id = c.id
...
$graph->title->Set('Ganhos recorrentes por categoria');
